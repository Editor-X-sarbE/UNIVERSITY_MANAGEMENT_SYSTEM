...
public class ViewEventsStudents implements ActionListener {
    JFrame display;
    Container c;
    ...
    public ViewEventsStudents() {
        ...
        searchbtn.setBounds(335, 130, 100, 30);
        ...
        printbtn.setBounds(100, 175, 100, 30);
        ...
        updatebtn.setBounds(220, 175, 100, 30);
        ...
        cancelbtn.setBounds(335, 175, 100, 30);
        ...
        ImageIcon ic = new ImageIcon(ClassLoader.getSystemResource("ViewLibraryStudent.jpg"));
    ...
    public void actionPerformed(ActionEvent ae) {
        try {
            ...
            if (ae.getSource() == searchbtn) {
                String query = "select * from EventPageAdmin where Eventname= '" + searchbarfld.getSelectedItem() + "'";
                try {
                    Connector c = new Connector();
