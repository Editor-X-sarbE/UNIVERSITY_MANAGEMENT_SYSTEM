...
public class ViewStudentDetailsForm implements ActionListener {
    JFrame display;
    Container c;
    ...
    public ViewStudentDetailsForm() {
        ...
        viewstddtltxt = new JLabel("VIEW STUDENT DETAILS");
        ...
        ImageIcon ic = new ImageIcon(ClassLoader.getSystemResource("viewdtlsx.jpg"));
