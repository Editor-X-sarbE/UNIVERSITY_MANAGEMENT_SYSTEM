...
public class ViewFaculityDetsilsForm implements ActionListener {
    JFrame display;
    Container c;
    ...
    public ViewFaculityDetsilsForm() {
        display = new JFrame();
        ...
        viewstddtltxt = new JLabel("VIEW FACULITY DETAILS");
        ...
        searchbartxt.setBounds(110, 80, 320, 100);
        searchbartxt.setForeground(Color.DARK_GRAY);
        ...
        searchbarfld.setBounds(450, 115, 150, 30);
        ...
        ImageIcon ic = new ImageIcon(ClassLoader.getSystemResource("view1.jpg"));
    ...
    public void actionPerformed(ActionEvent ae) {
        try {
            if (ae.getSource() == searchbtn) {
                ...
                new UpdateFaculityInformationPage();
            } else {
                new HomePage();
            }
        } catch (Exception e) {
